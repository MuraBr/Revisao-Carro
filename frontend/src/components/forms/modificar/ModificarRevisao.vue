  ...
  <div class="cadastrar-revisao">
    <form @submit.prevent="submeter">
      <div class="form-group">
        ...
        <input type="date" id="data_revisao" v-model="form.data_revisao"
...
const props = defineProps(['revisao'])
...
const form = reactive({
  data_revisao: props.revisao.data_revisao,
  km_revisao: revisaoStore.formatarKm(props.revisao.km_revisao), 
  preco_total: revisaoStore.formatarPreco(props.revisao.preco_total),
  descricao: props.revisao.descricao,
});
